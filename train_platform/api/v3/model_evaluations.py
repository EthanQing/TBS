...
def create_model_evaluation(payload: ModelEvaluationCreate, db: Session = Depends(get_db)):
...
@router.post("/{job_id}/cancel", response_model=ModelEvaluationOut)
def cancel_model_evaluation(job_id: str):
    return _svc.cancel_job(job_id)


@router.websocket("/{job_id}/stream")
async def stream_model_evaluation(websocket: WebSocket, job_id: str):
