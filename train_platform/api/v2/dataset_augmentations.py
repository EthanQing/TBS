...
router = APIRouter(prefix="/datasets/{dataset_id}/augmentations", tags=["dataset-augmentations"])
...
def preview_dataset_augmentation(
    ...
    return _svc.preview(db, int(dataset_id), payload)
...
def create_dataset_augmentation(
    ...
    return _svc.create_job(db, int(dataset_id), payload)


@router.get("/{job_id}", response_model=DatasetAugmentationJobOut)
def get_dataset_augmentation(dataset_id: int, job_id: str):
    return _svc.get_job(int(dataset_id), str(job_id))


@router.post("/{job_id}/cancel", response_model=DatasetAugmentationCancelOut)
def cancel_dataset_augmentation(dataset_id: int, job_id: str):
    row = _svc.cancel_job(int(dataset_id), str(job_id))
...
def publish_dataset_augmentation(
    ...
    return _svc.publish_job(db, int(dataset_id), str(job_id), payload)


@router.websocket("/{job_id}/stream")
async def stream_dataset_augmentation(websocket: WebSocket, dataset_id: int, job_id: str):
    """
