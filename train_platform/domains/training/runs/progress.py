...
from .lifecycle import execution_matches, touch_heartbeat
...
def upsert_epoch_metrics(
    ...
    *,
    ...
    try:
        ...
        run = run_query.with_for_update().first()
        ...
        touch_heartbeat(db, str(run_id), expected_pid=expected_pid, commit=False,
                        allocation_id=allocation_id, expected_create_time=expected_create_time)
